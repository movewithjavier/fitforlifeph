...
const ContactSection: React.FC = () => {
  ...
  return (
    <section className="py-16 md:py-24 px-4 sm:px-6 xl:px-32 bg-blue-50">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Ready to transform your workplace wellness? Let's discuss how we can help your team thrive.
          </p>
        </motion.div>
          ...
          >
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Schedule a free consultation to discuss your company's wellness needs and discover how our programs can benefit your team.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@fitforlife.ph</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">30-minute free call</p>
                </div>
              </div>
            </div>
          </motion.div>
